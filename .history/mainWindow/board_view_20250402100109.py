...
class BoardWidget(QScrollArea):
    ...
    def __init__(self, parent=None, style_index=0):
        ...
        self.main_layout = QHBoxLayout(self.scrollWidget)
        self.main_layout.setContentsMargins(60, 20, 60, 20)
        self.main_layout.setSpacing(20)  # 增加间距
        
        # 创建标题标签
        self.title_label = QLabel("五子棋游戏", self)
        self.title_label.setObjectName("interfaceTitle")
        ...
        self.gameLayout = QHBoxLayout(self.gameWidget)
        ...
        # 将左右面板添加到游戏区域布局
        self.gameLayout.addWidget(self.left_container, 3)  # 给棋盘区域更多的比例
        self.gameLayout.addWidget(self.right_panel, 0)  # 右侧面板不拉伸
        
        # 将游戏区域添加到主布局
        self.main_layout.addWidget(self.gameWidget)
        
        # 设置滚动区域的内容为scrollWidget
