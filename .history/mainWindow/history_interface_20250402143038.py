...
class HistoryListItem(QWidget):
    ...
    def update_favorite_status(self, is_favorite):
        """更新收藏状态图标"""
        self.is_favorite = is_favorite
        self.favorite_button.setIcon(FIF.HEART_FILL if is_favorite else FIF.HEART)  # 使用心形填充和空心图标
...
class FilterPanel(RoundedCardWidget):
    ...
    def __init__(self, parent=None):
        ...
        # 修复：使用正确的图标名称 CHEVRON_DOWN_MED 而不是 CHEVRON_DOWN
        self.collapse_button.setIcon(FIF.CHEVRON_DOWN_MED)
    ...
    def toggle_collapse(self):
        ...
        # 更新按钮图标 - 使用正确的图标名称
        self.collapse_button.setIcon(FIF.CHEVRON_RIGHT_MED if self._is_collapsed else FIF.CHEVRON_DOWN_MED)
...
class HistoryInterface(SmoothScrollArea):
    ...
    def setup_action_buttons(self):
        ...
        self.favorite_button = PushButton("收藏/取消", self, FIF.STAR)  # 修改为 STAR 或 FIF.STAR_EMPHASIS
