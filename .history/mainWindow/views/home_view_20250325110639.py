...
class HomeInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # 添加棋盘风格图片 (使用相对路径)
        boardStyles = [
            "resource/images/board_style1.png",
            "resource/images/board_style2.png",
            "resource/images/board_style3.png"
        ]
    ...
    def onStartGameBtnClicked(self):
        ...
        # 切换到游戏页面
        parent = self.parent()
        if parent and hasattr(parent, 'gameInterface'):
            parent.switchTo(parent.gameInterface)
