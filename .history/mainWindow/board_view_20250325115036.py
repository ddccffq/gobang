...
class BoardWidget(QWidget):
    ...
    @staticmethod
    def export_to_ui(filename="board_widget.ui"):
        """导出当前界面为UI文件（仅供参考，实际还需要手动在Qt Designer中重建）"""
        print(f"该方法仅提供参考，实际需要在Qt Designer中重建界面并保存为{filename}")
        print("请按照以下步骤操作：")
        print("1. 打开Qt Designer")
        print("2. 创建新的Widget")
        print("3. 按照代码中的布局添加组件")
        print("4. 保存为.ui文件")
...
class BoardWindow(FramelessWindow):
    ...
    @staticmethod
    def export_to_ui(filename="board_window.ui"):
        """导出当前界面为UI文件（仅供参考，实际还需要手动在Qt Designer中重建）"""
        print(f"该方法仅提供参考，实际需要在Qt Designer中重建界面并保存为{filename}")
        print("请按照以下步骤操作：")
        print("1. 打开Qt Designer")
        print("2. 创建新的MainWindow")
        print("3. 按照代码中的布局添加组件")
        print("4. 保存为.ui文件")
...
if __name__ == "__main__":
    # 测试导出UI文件说明
    BoardWidget.export_to_ui()
    BoardWindow.export_to_ui()
