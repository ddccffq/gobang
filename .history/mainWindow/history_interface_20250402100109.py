...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, QListWidget, 
                             ...
                             QDateEdit, QComboBox, QGridLayout, QCheckBox, QScrollArea)
from PyQt5.QtGui import QFont, QIcon
import os
import json
import datetime

from qfluentwidgets import PushButton, SearchLineEdit, InfoBar, InfoBarPosition, FluentIcon as FIF, isDarkTheme
...
class HistoryInterface(QScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        # 创建标题
        self.title_label = QLabel("历史对局", self)
        self.title_label.setObjectName("interfaceTitle")  # 使用统一的对象名
        ...
        # 将所有控件添加到内容容器的布局中，而不是直接添加到main_layout
        self.contentLayout.addLayout(self.search_filter_layout)
        self.contentLayout.addLayout(self.buttons_layout)
        self.contentLayout.addWidget(self.status_label)
        self.contentLayout.addWidget(self.history_list)
        
        # 将内容容器添加到主布局
        self.main_layout.addWidget(self.contentWidget)
        
        # 设置标题位置
        self.title_label.move(60, 63)
