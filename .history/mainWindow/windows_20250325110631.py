...
from interfaces import StackedWidget
...
class Window(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.gameInterface = GameInterface(self)  # 更改为GameInterface
        self.historyInterface = HistoryInterface(self)  # 更改为HistoryInterface
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.gameInterface, FIF.GAME, '游戏')  # 修改为游戏图标和名称

        self.addSubInterface(self.historyInterface, FIF.HISTORY, '历史记录', NavigationItemPosition.BOTTOM, FIF.LIBRARY_FILL)  # 修改为历史记录
        ...
        self.navigationBar.addItem(
            ...
            icon=FIF.HELP,
            text='帮助',
            onClick=lambda: self.showMessageBox(),  # 修改为显示帮助信息
            selectable=False,
    ...
    def initWindow(self):
        ...
        self.setWindowTitle('五子棋游戏')  # 修改窗口标题
