...
class HistoryInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.history_dir = history_manager.history_dir
    ...
    def import_game(self):
        ...
        try:
            ...
            # 使用与保存时相同的格式生成新文件名
            new_file_name = f"对战_{current_time}_{winner_str}.json"
            
            # 新文件的完整路径
            new_file_path = os.path.join(self.history_dir, new_file_name)
